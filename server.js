...
// [GET] Lấy danh sách lịch sử bài làm (Test Reviews) theo UserID
...
/* --------------------------------------------------------------------------
   GROUP 3: QUESTIONS (Ngân hàng câu hỏi)
   -------------------------------------------------------------------------- */
...
app.get('/api/questions', async (req, res) => {
    try {
        ...
        // Chỉ lọc theo Category nếu có truyền ID hợp lệ
...
/* --------------------------------------------------------------------------
   GROUP 4: TESTS & REVIEWS (Tạo đề thi, Chấm điểm, Xem kết quả)
   -------------------------------------------------------------------------- */

// [GET] Sinh đề thi ngẫu nhiên
app.get('/api/test/generate', async (req, res) => {
    try {
        ...
        // Lấy tên Category cho tiêu đề bài thi
...
/* ==========================================================================
   7. MAIN ROUTES (HTML PAGES) & SERVER START
   ========================================================================== */
